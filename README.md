...
#!/usr/bin/php
#
# Manticore configuration file sample
#
<?php

use Symfony\Component\Dotenv\Dotenv;
use Symfony\Component\ErrorHandler\Debug;
use Wucdbm\Manticore\ConfigFactory\EnvContainer;
use Wucdbm\Manticore\ConfigFactory\Factory;
...
echo $factory->configs([
    ...
    $factory->createSearchdConfig([
        'listen' => [
            ...
            // 9306 SphinxQL / mysql41 Port
            $factory->listen('${ip}:${mysql_port}:mysql41'),
            // 9308 HTTP API port
            $factory->listen('${ip}:9308:http'),
            $factory->listen('${ip}:9443:https'),
        ],
        'log' => $logPath,
